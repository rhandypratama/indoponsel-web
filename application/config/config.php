...
// $config['base_url'] = 'https://'.$_SERVER['HTTP_HOST'].str_replace('//', '/', dirname($_SERVER['SCRIPT_NAME']).'/');
$config['base_folder'] = $_SERVER['DOCUMENT_ROOT']."/crawler/";
$config['web_title'] = 'Indoponsel';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
