<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar pb-0 pt-0" style="background-color:#fafafa!important">
<!-- <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bg-gradient-primary"> -->
    ...
    <a class="navbar-brand mr-0 mr-md-4" href="<?php echo base_url();?>" aria-label="Bootstrap">
        <!-- <img src="/asset/images/logo.png" class="img-responsive" width="38px" height="38px"/> -->
        <img src="/asset/images/logo.png" class="img-responsive mt-sm-8" style=""/>
    </a>    
        ...
        <ul class="navbar-nav bd-navbar-nav flex-row">
            <?php
                ...
                if ($uri1 == 'home' || $uri1 == '') {
                    ...
                    $statusLoker = '';
                    $statusKontak = '';
                } else if ($uri1 == 'loker' && $uri2 != 'kontak') {
                    $statusHome = '';
                    $statusLoker = 'active';
                    $statusKontak = '';
                } else if ($uri1 == 'loker' && $uri2 == 'kontak') {
            ...
            ?>
            <li class="nav-item"><a class="nav-link <?php echo $statusHome; ?>" href="<?php echo base_url();?>">Gadget</a></li>
            <li class="nav-item"><a class="nav-link <?php echo $statusLoker; ?>" href="<?php echo base_url('loker');?>">Lowongan Kerja</a></li>
            <li class="nav-item"><a class="nav-link <?php echo $statusKontak; ?>" href="<?php echo base_url('loker/kontak');?>">Contact Us</a></li>
            <!-- <li class="nav-item"><a class="nav-link " href="#" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Examples');">Trending</a></li> -->
            <!-- <li class="nav-item"><a class="nav-link" href="#" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Themes');" target="_blank" rel="noopener">Gadget Baru</a></li> -->
            <!-- <li class="nav-item"><a class="nav-link" href="https://expo.getbootstrap.com/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Expo');" target="_blank" rel="noopener">Expo</a></li>
            <li class="nav-item"><a class="nav-link" href="https://blog.getbootstrap.com/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Blog');" target="_blank" rel="noopener">Blog</a></li> -->
        </ul>
    </div>

    <!-- <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
        <li class="nav-item dropdown">
            <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">v4.1</a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
                <a class="dropdown-item active" href="https://getbootstrap.com/docs/4.1/">Latest (4.1.x)</a>
    ...
    <!-- <a class="btn btn-bd-download d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="https://getbootstrap.com/docs/4.1/getting-started/download/">Download</a> -->
</header>