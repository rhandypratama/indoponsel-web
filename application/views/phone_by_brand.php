	...
	<div class="row flex-xl-nowrap">
		...
		<main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
			...
			<?php
				...
				if ($uri1 == 'home' && $uri2 == 'brand' && $uri3 == 'Samsung') {
					$imgLazada = 'https://media.go2speed.org/brand/files/lazada/8821/ID_SamsungProdukJuara2018_728x90.jpg';
					$URLLazada = 'https://c.lazada.co.id/t/c.Zh5a';
				} else {
					$imgLazada = 'https://media.go2speed.org/brand/files/lazada/8254/ID_XiaomiA1Oct2017_728x90.jpg';
					$URLLazada = 'https://c.lazada.co.id/t/c.Zrqk';
				}
				echo '<a href="'.$URLLazada.'" target="_blank" title="Lazada Promo"><img alt="Lazada" class="img-fluid" src="'.$imgLazada.'"></a>';
			?>
			</div>
			<div class="row">
			<?php 
				// d($link);
				$totalRow = count($phoneByBrand);
			...
			<?php if ($phoneByBrand) if (isset($link) && $link != '') { ?>
				<hr>
				<?php echo $link; ?>
			<?php } ?>
		</main>
